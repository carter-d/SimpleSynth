...
- (void)initValidation:(NSDictionary * _Nonnull)dict;

/// Validation function that you will probably call from the initValidation function. This function will make sure the passed on keys are not in the dictionary used for initialisation. The result of this validation is stored in evReflectionStatus.
///
/// \param keys The fields that may not be in the dictionary (like an error key)
///
/// \param dict The dictionary that is passed on from the initValidation function
- (void)initMayNotContainKeys:(NSArray<NSString *> * _Nonnull)keys dict:(NSDictionary * _Nonnull)dict;

/// Validation function that you will probably call from the initValidation function. This function will make sure the passed on keys are in the dictionary used for initialisation. The result of this validation is stored in evReflectionStatus.
///
/// \param keys The fields that may not be in the dictionary (like an error key)
///
/// \param dict The dictionary that is passed on from the initValidation function
- (void)initMustContainKeys:(NSArray<NSString *> * _Nonnull)keys dict:(NSDictionary * _Nonnull)dict;
@end
